          ...
          >
            <div className='fixed w-screen h-screen z-20'>
              <div className='flex flex-col w-[20rem] h-full left-0 bg-white absolute z-30 '>
                <div
                  onClick={() => dispatch(showMenuSidebar())}
                  className='bg-white p-3 rounded-full inline-block -right-6 top-3 shadow-lg hover:bg-primary cursor-pointer hover:text-white ease-in-out duration-300  absolute z-30'
                >
                      ...
                      <li className='group flex justify-between items-center p-2 hover:bg-gray-100 ease-in-out duration-300 hover:rounded'>
                        ...
                        <div>
                          <MdKeyboardArrowRight
                            size={25}
                            className='group-hover:rotate-90 ease-in-out duration-300 group-hover:text-primary'
                          />
                        </div>
                      </li>
                      <ul className='font-normal px-10 mt-2 overflow-y-scroll h-44 mb-4'>
                        <Link href='#'>
                          <li className='hover:bg-gray-100 rounded p-1 cursor-pointer flex items-center gap-x-2 group'>
                            {' '}
                            <HiOutlineMinusSm className='group-hover:rotate-90 ease-in-out duration-300 group-hover:text-primary' />{' '}
                            asdasdasd
                          </li>
                        </Link>
                        <Link href='#'>
                ...
                <h4 className='text-center p-4'>
                  ...
                  <span className='text-primary font-medium hover:cursor-pointer hover:underline'>
                    <Link href='https://github.com/rahmancaylak'>
                      Rahman Çaylak
                    </Link>
                  </span>
                </h4>
